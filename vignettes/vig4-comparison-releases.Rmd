...
![](figures/belgium2022.png){width=450, alt="Data Package 2022"}

![](figures/belgium2023.png){width=450, alt="Data Package 2023"}
...
![](figures/belgium_built2022.png){width=450, alt="Fixed built-up threshold of 50%"}

![](figures/belgium_built2023.png){width=450, alt="Optimal built-up threshold"}
