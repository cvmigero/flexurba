...
plot1 <- plot_grid(classification_1) +
...
plot2 <- plot_grid(classification_2) +
  ggspatial::annotation_scale(
    pad_x = grid::unit(0.08, "npc"),
    pad_y = grid::unit(0.10, "npc"),
    width_hint = 0.10,
...
plot3 <- plot_grid(classification_3) +
  ggspatial::annotation_scale(
    pad_x = grid::unit(0.08, "npc"),
    pad_y = grid::unit(0.10, "npc"),
    width_hint = 0.10,
...
plot4 <- plot_grid(classification_4) +
  ggspatial::annotation_scale(
    pad_x = grid::unit(0.08, "npc"),
    pad_y = grid::unit(0.10, "npc"),
    width_hint = 0.10,
