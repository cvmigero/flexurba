...
writeRaster(t1, here::here('inst/paper/output/t1.tif'))
writeRaster(t2, here::here('inst/paper/output/t2.tif'))
writeRaster(t3, here::here('inst/paper/output/t3.tif'))
writeRaster(t4, here::here('inst/paper/output/t4.tif'))
writeRaster(t5, here::here('inst/paper/output/t5.tif'))
writeRaster(t6, here::here('inst/paper/output/t6.tif'))
