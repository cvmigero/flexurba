...
#' @examples
#' \dontrun{
#' # assuming that "data/belgium" contains the necessary data files
...
#' 
#' `preprocess_grid()` has been renamed to `DoU_preprocess_grid()` to create a more consistent API and to better indicate that this function is specifically designed for preprocessing the grid data to reconstruct the DEGURBA classification with `classify_grid()`. 
