...
![](man/figures/readme_classification1.png){width="450", alt="Grid classification 1"}
...
![](man/figures/readme_classification2.png){width="450", alt="Grid classification 2"}
...
![](man/figures/readme_unitsclassification1.png){width="500", alt="Units classification 1"}
...
-   The `vignette("vig7-population-grid")` illustrates how the package function can be used with other population grids (e.g. WorldPop).
