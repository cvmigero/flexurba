test_that("DoU_classify_units() works", {
  ...
  data <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop)
  units_classification <- flexurba::DoU_classify_units(data)

  expect_equal(as.vector(units_classification$flexurba_L1)[20:30], c("3", "3", "2", "2", "3", "2", "2", "3", "2" , "3", "3"))
  expect_equal(as.vector(units_classification$flexurba_L1)[100:110], c("2","1", "2", "2", "2", "1", "1", "2", "2", "2", "1"))

  # units classification by dissolving municipalities to arrondissements
  data2 <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop, dissolve_units_by = "GID_3")
  units_classification2 <- flexurba::DoU_classify_units(data2, id = "GID_3")

  expect_equal(as.vector(units_classification2$flexurba_L1)[20:30], c("2", "2", "2", "2", "2", "1", "3", "3", "2", "2", "2"))
  ...
  # LEVEL 2
  # get units classification
  classification <- system.file("extdata", "belgium", "classification6.tif", package = "flexurba")
  data <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop)
  units_classification <- flexurba::DoU_classify_units(data, level1 = FALSE, rules_from_2021 = TRUE)

  expect_equal(as.vector(units_classification$flexurba_L2)[20:30], c("30","30", "21", "30", "30","23", "22", "30", "21", "30", "30"))
  expect_equal(as.vector(units_classification$flexurba_L2)[100:110], c("21", "13", "23", "23", "21", "13", "13", "23", "21", "21", "13"))
  
  units_classification_updated <- flexurba::DoU_classify_units(data, level1 = FALSE)
  
  expect_equal(as.vector(units_classification_updated$flexurba_L2)[20:30], c("30","30", "22", "30", "30","23", "22", "30", "22", "30", "30"))
  expect_equal(as.vector(units_classification_updated$flexurba_L2)[100:110], c("22", "13", "23", "22", "22", "13", "13", "22", "22", "22", "13"))

  # units classification by dissolving municipalities to arrondissements
  data2 <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop, dissolve_units_by = "GID_3")
  units_classification2 <- flexurba::DoU_classify_units(data2, id = "GID_3", level1 = FALSE)

  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("30", "22", "21", "22", "22", "13", "30", "30", "22", "22", "21"))
  
  # deprecated functions
  # units classification by dissolving municipalities to arrondissements
  data2 <- flexurba::preprocess_units(flexurba::units_belgium, classification, pop, dissolve_units_by = "GID_3")
  units_classification2 <- flexurba::classify_units(data2, id = "GID_3", level1 = FALSE)
  
  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("30", "23", "21", "21", "23", "12", "30", "30", "21", "21", "21"))
})
