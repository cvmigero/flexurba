test_that("DoU_classify_units() works", {
  # LEVEL1
  # load data
  classification <- DoU_classify_grid(system.file("extdata", "belgium", package = "flexurba"))
  ...
  expect_equal(as.vector(units_classification$flexurba_L1)[20:30], c("3", "3", "2", "3", "3", "2", "2", "3", "2" , "3", "3"))
  ...
  expect_equal(as.vector(units_classification2$flexurba_L1)[20:30], c("3", "2", "2", "2", "2", "1", "3", "3", "2", "2", "2"))
  ...
  # LEVEL 2
  # get units classification
  classification <- DoU_classify_grid(system.file("extdata", "belgium", package = "flexurba"), level1=FALSE)
  data <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop)
  units_classification <- flexurba::DoU_classify_units(data, level1 = FALSE, rules_from_2021 = TRUE)

  expect_equal(as.vector(units_classification$flexurba_L2)[20:30], c("30","30", "21", "30", "30","23", "21", "30", "21", "30", "30"))
  ...
  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("30", "22", "22", "21", "22", "13", "30", "30", "22", "22", "22"))
  ...
  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("30","21","21","22","23","12","30","30", "21", "23", "21"))
})
