test_that("DoU_classify_units() works", {
  ...
  expect_equal(as.vector(units_classification$flexurba_L1)[20:30], c("3", "2", "3", "2", "2", "3", "1", "2", "2", "3", "2"))
  expect_equal(as.vector(units_classification$flexurba_L1)[100:110], c("2", "2", "3", "2", "2", "2", "2", "1", "2", "2", "2"))
  ...
  expect_equal(as.vector(units_classification2$flexurba_L1)[20:30], c("2", "2", "1", "3", "2", "2", "1", "2", "2", "2", "3"))
  ...
  expect_equal(as.vector(units_classification$flexurba_L2)[20:30], c("30", "21", "30", "23", "21", "30", "12", "21", "21", "30", "22"))
  expect_equal(as.vector(units_classification$flexurba_L2)[100:110], c("23", "22", "30", "21", "22", "21", "22", "12", "21", "21", "23"))

  # units classification by dissolving municipalities to arrondissements
  data2 <- flexurba::DoU_preprocess_units(flexurba::units_belgium, classification, pop, dissolve_units_by = "GID_3")
  units_classification2 <- flexurba::DoU_classify_units(data2, id = "GID_3", level1 = FALSE)

  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("21", "23", "13", "30", "22", "22", "13", "22", "23", "22", "30"))
  ...
  expect_equal(as.vector(units_classification2$flexurba_L2)[20:30], c("23", "21", "12", "30", "21", "23", "12", "23", "21", "21", "30"))
})
