...
expect_equal(sum(terra::values(withzones1$rboundaries), na.rm=TRUE), 1797)
...
expect_equal(sum(terra::values(withzones2$rboundaries), na.rm=TRUE), 188)
...
expect_equal(sum(terra::values(withzones3$rboundaries), na.rm=TRUE), 1683)
