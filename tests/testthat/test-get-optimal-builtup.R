test_that("DoU_get_optimal_builtup() works", {
  ...
  expect_equal(
    round(DoU_get_optimal_builtup(system.file("extdata", "belgium", package = "flexurba"),
  ...
  expect_error(DoU_get_optimal_builtup(system.file("extdata", "belgium", package = "flexurba"),
    directions = 5
  ))
})
